 ...
 */
public class PLMediaPlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.BtnPlay:
//                停止播放
                if (btn_play.getText().toString().contentEquals("停止")) {
                    onClickStop();
                    btn_play.setText("开始");
            ...
            case R.id.BtnPause:
                //运行状态，点击，暂停播放
                if (btn_pause.getText().toString().contentEquals("暂停")) {
                    onClickPause();
